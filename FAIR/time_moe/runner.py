...
class TimeMoeRunner:
    ...
    def train_model(self, from_scratch: bool = False, **kwargs):
        ...
        #         data_path=data_path,
        #         time_normalization=time_norm_method,
        ...
        if is_time_aware_dataset and data_path.endswith('.jsonl'):
            ...
            time_normalization = train_config.get('time_normalization', 'minmax') # e.g., 'standard' or None
            quantize_res = train_config.get('time_quantize_resolution', None)
            auto_quantize = train_config.get('time_auto_quantize', True)
