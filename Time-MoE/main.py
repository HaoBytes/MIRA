...
if __name__ == '__main__':
    ...
    parser.add_argument('--time_aware', action='store_true', help='Enable time-aware dataset loading')

    parser.add_argument('--config_path', type=str, default=None) # we custom the model config
    ...
    config_dict.update({
        ...
        'time_aware_rotary': args.time_aware  
    })
    custom_config = TimeMoeConfig(**config_dict)
